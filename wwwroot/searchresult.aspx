<%@ Page  Language="C#" MasterPageFile="India.Master" AutoEventWireup="true" CodeFile="SearchResult.aspx.cs" Inherits="SearchResult" Title="Search Result" %>
  ...
  <div class="container">		
	<div id="main-content-wrap">
		<div id="main-content" class="clearfix">
			<div id="breadcrumbs">
					<a href="../Default.aspx" title="India City Trip">Home</a> &raquo; Search Results</div> <!-- end #breadcrumbs -->			<div id="top-shadow"></div>
