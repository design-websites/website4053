...
<li class="clearfix">
			<a href="#">
			<img src="images/Punjab/Anandpur-sahib-fort.jpeg" alt="Anandpur Sahib Fort" title="Anandpur Sahib Fort"  width="74" height="74"/>		</a>
		<span class="right">
		<a href="#">
...
<li class="clearfix">
			<a href="#">
			<img src="images/Punjab/Bathinda-fort.jpeg" alt="Bathinda Fort" title="Bathinda Fort"  width="74" height="74"/>		</a>
		<span class="right">
		<a href="#">
...
<li class="clearfix">
			<a href="#">
			<img src="images/Punjab/Faridkot-Fort.jpeg" alt="Faridkot Fort" title="Faridkot Fort"  width="74" height="74"/>		</a>
		<span class="right">
		<a href="#">
...
<li class="clearfix">
			<a href="#">
			<img src="images/Punjab/qila-mubarak-patiala.jpeg" alt="Qila Mubarak" title="Qila Mubarak"  width="74" height="74"/>		</a>
		<span class="right">
		<a href="#">
...
<li class="clearfix">
			...
			<img src="images/Gujarat/Amritsar.jpg" alt="Golden Temple, Amritsar" title="Amritsar Tour"  width="74" height="74"/>		</a>
		<span class="right">
		<a href="Punjab-Destinations/Amritsar.aspx">
...
<li class="clearfix">
			...
			<img src="images/Punjab/jallianwala-bagh-memorial.jpeg" alt="Jallianwala Bagh, Hoshiarpur" title="Jallianwala Bagh, Hoshiarpur"  width="74" height="74"/>		</a>
		<span class="right">
		<a href="Punjab-Destinations/Hoshiarpur.aspx">
...
<li class="clearfix">
			...
			<img src="images/Punjab/Devi-talab-mandir-jalandhar.jpeg" alt="Devi Talab Mandir, Jalandhar" title="Devi Talab Mandir, Jalandhar"  width="74" height="74"/>		</a>
		<span class="right">
		<a href="Punjab-Destinations/Jalandhar.aspx">
...
<li class="clearfix">
			...
			<img src="images/Punjab/Nehru-Rose-garden-ludhiana.jpeg" alt="Nehru Rose Garden, Punjab" title="Nehru Rose Garden, Punjab"  width="74" height="74"/>		</a>
		<span class="right">
		<a href="Punjab-Destinations/Ludhiana.aspx">
...
<li class="clearfix">
			...
			<img src="images/Punjab/Seesh-mahal-patiala.jpeg" alt="Seesh Mahal, Patiala" title="Seesh Mahal, Patiala"  width="74" height="74"/>		</a>
		<span class="right">
		<a href="Punjab-Destinations/Patiala.aspx">
...
<li class="clearfix">
   <a href="http://gallery.indiacitytrip.com/punjab/" target="_blank">
...
<li class="clearfix">
   <a href="http://gallery.indiacitytrip.com/punjab/amritsar/" target="_blank">
