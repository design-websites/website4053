<%@ Page Title="Places to see" Language="C#" MasterPageFile="Inner.Master" AutoEventWireup="true" CodeFile="places-to-see.aspx.cs" Inherits="places_to_see" CodeFileBaseClass="BasePage"
Meta_Keywords="Places to see, Things to do, places to visit, things to see" Meta_Description="Places to see in India, Hillstations, forts, beaches, wild life, theme parks, historica, shopping, markets are described here."
%>
<%@ Register Src="control/Explore.ascx" TagName="right" TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <div class="slide" style="background: url(https://storage.googleapis.com/kreatewebsites/banner_all/Bangalore-tour.jpg) no-repeat scroll center top rgb(77, 26, 11); display: block;">
			 	<!-- end .container -->	
		</div> <!-- end .slide -->	
  <div class="container">		
	<div id="main-content-wrap">
		<div id="main-content" class="clearfix">
			<div id="breadcrumbs">		
					<a href="Default.aspx" title="India City Trip">Home</a> &#187; Places to See in India</div> <!-- end #breadcrumbs -->			<div id="top-shadow"></div>
			<div id="recent-posts" class="clearfix">
				<div class="entry post clearfix">
					<h1 class="title" title="Places to see">Places to See</h1>
<div class="entry-content"  style="background-color:#FFF7E7">

<form id="Form1" action="places-to-see.aspx" runat="server" style="color:Black" >
...
<td>
        <asp:TreeView ID="TreeView1"
          ...
          <Nodes>
<asp:TreeNode Text="Places to see in India" NavigateUrl="Default.aspx">
<asp:TreeNode Text="Andhra Pradesh" NavigateUrl="Andhra-Pradesh.aspx">
<asp:TreeNode Text="Hyderabad Film Studio" NavigateUrl="Andhra-Pradesh-Destinations/a-day-trip-to-hyderabad-film-studio.aspx"/>
<asp:TreeNode Text="Guntur" NavigateUrl="Andhra-Pradesh-Destinations/Guntur.aspx"/>
<asp:TreeNode Text="Hyderabad" NavigateUrl="Andhra-Pradesh-Destinations/Hyderabad.aspx"/>
<asp:TreeNode Text="Secunderabad" NavigateUrl="Andhra-Pradesh-Destinations/Secunderabad.aspx"/>
<asp:TreeNode Text="Tirupati" NavigateUrl="Andhra-Pradesh-Destinations/tirupati.aspx"/>
<asp:TreeNode Text="Vijayawada" NavigateUrl="Andhra-Pradesh-Destinations/Vijayawada.aspx"/>
<asp:TreeNode Text="Vishakapatnam" NavigateUrl="Andhra-Pradesh-Destinations/Vishakapatnam.aspx"/>
<asp:TreeNode Text="Warangal" NavigateUrl="Andhra-Pradesh-Destinations/Warangal.aspx"/>
<asp:TreeNode Text="Secunderabad" NavigateUrl="Andhra-Pradesh-Destinations/places-to-see-in-secunderabad.aspx"/>
</asp:TreeNode>                     
<asp:TreeNode Text="Arunachal Pradesh" NavigateUrl="Arunachal-Pradesh.aspx">
<asp:TreeNode Text="Itanagar" NavigateUrl="Arunachal-Pradesh-Destinations/Itanagar.aspx"/>
<asp:TreeNode Text="Itanagar" NavigateUrl="Arunachal-Pradesh-Destinations/places-to-see-in-itanagar.aspx"/>

</asp:TreeNode>
<asp:TreeNode Text="Assam" NavigateUrl="Assam.aspx">
<asp:TreeNode Text="Guwahati" NavigateUrl="Assam-Destinations/Guwahati.aspx"/>
...
<asp:TreeNode Text="Guwahati" NavigateUrl="Assam-Destinations/places-to-see-in-guwahati.aspx"/>
</asp:TreeNode>
<asp:TreeNode Text="Bihar" NavigateUrl="Bihar.aspx">
<asp:TreeNode Text="Bodhgaya" NavigateUrl="Bihar-Destinations/bodhgaya.aspx"/>
<asp:TreeNode Text="Patna" NavigateUrl="Bihar-Destinations/Patna.aspx"/>
</asp:TreeNode>
...
<asp:TreeNode Text="Mehrauli" NavigateUrl="Delhi-Destinations/places-to-visit-mehrauli.aspx"/>
</asp:TreeNode>
...
<asp:TreeNode Text="Ahmedabad" NavigateUrl="Gujarat-Destinations/Ahmedabad.aspx"/>
<asp:TreeNode Text="Bhuj" NavigateUrl="Gujarat-Destinations/bhuj-tour.aspx"/>
<asp:TreeNode Text="Dandi" NavigateUrl="Gujarat-Destinations/dandi-tour.aspx"/>
<asp:TreeNode Text="Rajkot" NavigateUrl="Gujarat-Destinations/Rajkot.aspx"/>
<asp:TreeNode Text="Surat" NavigateUrl="Gujarat-Destinations/Surat.aspx"/>
<asp:TreeNode Text="Vadodara" NavigateUrl="Gujarat-Destinations/Vadodara.aspx"/>
<asp:TreeNode Text="Gir National Park" NavigateUrl="Gujarat-Destinations/Gir-National-Park.aspx"/>
<asp:TreeNode Text="Gandhinagar" NavigateUrl="Gujarat-Destinations/places-to-see-in-gandhinagar.aspx"/>
...
<asp:TreeNode Text="Chandigarh" NavigateUrl="Haryana-Destinations/chandigarh.aspx"/>
<asp:TreeNode Text="Faridabad" NavigateUrl="Haryana-Destinations/Faridabad.aspx"/>
<asp:TreeNode Text="Kurukshetra" NavigateUrl="Haryana-Destinations/kurukshetra.aspx"/>
<asp:TreeNode Text="Manesar" NavigateUrl="Haryana-Destinations/manesar-tour.aspx"/>
<asp:TreeNode Text="Hisar" NavigateUrl="Haryana-Destinations/places-to-see-in-hisar.aspx"/>
<asp:TreeNode Text="Panipat" NavigateUrl="Haryana-Destinations/panipat.aspx"/>
<asp:TreeNode Text="Bhiwani" NavigateUrl="Haryana-Destinations/places-to-visit-in-bhiwani.aspx"/>
<asp:TreeNode Text="Gurgaon" NavigateUrl="Haryana-Destinations/places-to-see-in-gurgaon.aspx"/>
...
<asp:TreeNode Text="Himachal Pradesh" NavigateUrl="Himachal-Pradesh.aspx" ImageUrl="https://storage.googleapis.com/createweb/indiacitytrip.com/code/images/folder.gif" >
<asp:TreeNode Text="Chamba" NavigateUrl="Gujarat-Destinations/chamba-tour.aspx"/>
<asp:TreeNode Text="Dalhousie" NavigateUrl="Himachal-Pradesh-Destinations/Dalhousie.aspx"/>
<asp:TreeNode Text="Dharamsala" NavigateUrl="Himachal-Pradesh-Destinations/Dharamsala.aspx"/>
<asp:TreeNode Text="Manali" NavigateUrl="Himachal-Pradesh-Destinations/Manali.aspx"/>
<asp:TreeNode Text="Shimla" NavigateUrl="Himachal-Pradesh-Destinations/Shimla.aspx"/>
...
<asp:TreeNode Text="Dharamshala" NavigateUrl="Himachal-Pradesh-Destinations/places-to-see-in-dharamshala.aspx"/>
...
<asp:TreeNode Text="Amarnath" NavigateUrl="Jammu-Kashmir-Destinations/Amarnath-Yatra.aspx"/>
<asp:TreeNode Text="Ladakh" NavigateUrl="Jammu-Kashmir-Destinations/Ladakh.aspx"/>
<asp:TreeNode Text="Vaishnodevi" NavigateUrl="Jammu-Kashmir-Destinations/Vaishnodevi.aspx"/>
<asp:TreeNode Text="Dachigam National Park" NavigateUrl="Jammu-Kashmir-Destinations/Dachigam-National-Park.aspx"/>
<asp:TreeNode Text="Jammu Temples" NavigateUrl="Jammu-Kashmir-Destinations/temples-in-jammu.aspx"/>
</asp:TreeNode>
...
<asp:TreeNode Text="Ranchi" NavigateUrl="Jharkhand-Destinations/Ranchi.aspx"/>
</asp:TreeNode>
...
<asp:TreeNode Text="Bangalore" NavigateUrl="Karnataka-Destinations/Bangalore.aspx"/>
<asp:TreeNode Text="Hubli" NavigateUrl="Karnataka-Destinations/hubli-tour.aspx"/>
...
<asp:TreeNode Text="Alleppey" NavigateUrl="Kerala-Destinations/Alleppey.aspx"/>
<asp:TreeNode Text="Calicut" NavigateUrl="Kerala-Destinations/Calicut.aspx"/>
<asp:TreeNode Text="Cochin" NavigateUrl="Kerala-Destinations/Cochin.aspx"/>
<asp:TreeNode Text="Kollam" NavigateUrl="Kerala-Destinations/Kollam.aspx"/>
<asp:TreeNode Text="Kottayam" NavigateUrl="Kerala-Destinations/Kottayam.aspx"/>
<asp:TreeNode Text="Kozhikode" NavigateUrl="Kerala-Destinations/Kozhikode.aspx"/>
<asp:TreeNode Text="Munnar" NavigateUrl="Kerala-Destinations/Munnar.aspx"/>
<asp:TreeNode Text="Trivandrum" NavigateUrl="Kerala-Destinations/Trivandrum.aspx"/>
<asp:TreeNode Text="Thiruvananthapuram" NavigateUrl="Kerala-Destinations/Thiruvananthapuram.aspx"/>
<asp:TreeNode Text="Kumarakom Bird Sanctuary" NavigateUrl="Kerala-Destinations/Kumarakom-Bird-Sanctuary.aspx"/>
...
<asp:TreeNode Text="Bhopal" NavigateUrl="Madhya-Pradesh-Destinations/Bhopal.aspx"/>
<asp:TreeNode Text="Indore" NavigateUrl="Madhya-Pradesh-Destinations/Indore.aspx"/>
<asp:TreeNode Text="Jabalpur" NavigateUrl="Madhya-Pradesh-Destinations/Jabalpur.aspx"/>
<asp:TreeNode Text="Pachmarhi" NavigateUrl="Madhya-Pradesh-Destinations/Pachmarhi.aspx"/>
<asp:TreeNode Text="Ujjain" NavigateUrl="Madhya-Pradesh-Destinations/Ujjain.aspx"/>
...
<asp:TreeNode Text="Aurangabad" NavigateUrl="Maharashtra-Destinations/Aurangabad.aspx"/>
<asp:TreeNode Text="Khandala" NavigateUrl="Maharashtra-Destinations/khandala.aspx"/>
<asp:TreeNode Text="Lonavala" NavigateUrl="Maharashtra-Destinations/Lonavala.aspx"/>
<asp:TreeNode Text="Mahabaleshwar" NavigateUrl="Maharashtra-Destinations/Mahabaleshwar.aspx"/>
<asp:TreeNode Text="Malegaon" NavigateUrl="Maharashtra-Destinations/malegaon-tour.aspx"/>
<asp:TreeNode Text="Mumbai" NavigateUrl="Maharashtra-Destinations/Mumbai.aspx"/>
<asp:TreeNode Text="Nagpur Travel" NavigateUrl="Maharashtra-Destinations/Nagpur.aspx"/>
<asp:TreeNode Text="Nasik" NavigateUrl="Maharashtra-Destinations/Nasik.aspx"/>
<asp:TreeNode Text="Navi Mumbai" NavigateUrl="Maharashtra-Destinations/Navi-Mumbai.aspx"/>
<asp:TreeNode Text="Pune travel" NavigateUrl="Maharashtra-Destinations/pune.aspx"/>
<asp:TreeNode Text="Satara" NavigateUrl="Maharashtra-Destinations/Satara.aspx"/>
<asp:TreeNode Text="Solapur" NavigateUrl="Maharashtra-Destinations/Solapur.aspx"/>
<asp:TreeNode Text="Thane" NavigateUrl="Maharashtra-Destinations/Thane.aspx"/>
...
<asp:TreeNode Text="Imphal" NavigateUrl="Manipur-Destinations/Imphal.aspx"/>
</asp:TreeNode>
...
<asp:TreeNode Text="Bhubaneshwar" NavigateUrl="Orissa-Destinations/Bhubaneshwar.aspx"/>
<asp:TreeNode Text="Cuttack" NavigateUrl="Orissa-Destinations/Cuttack.aspx"/>
...
<asp:TreeNode Text="Amritsar" NavigateUrl="Punjab-Destinations/Amritsar.aspx"/>
<asp:TreeNode Text="Hoshiarpur" NavigateUrl="Punjab-Destinations/Hoshiarpur.aspx"/>
<asp:TreeNode Text="Jalandhar" NavigateUrl="Punjab-Destinations/Jalandhar.aspx"/>
<asp:TreeNode Text="Ludhiana" NavigateUrl="Punjab-Destinations/Ludhiana.aspx"/>
<asp:TreeNode Text="Patiala" NavigateUrl="Punjab-Destinations/Patiala.aspx"/>
...
<asp:TreeNode Text="Bhilwara" NavigateUrl="Rajasthan-Destinations/bhilwara-tour.aspx"/>
...
<asp:TreeNode Text="Pilani" NavigateUrl="Rajasthan-Destinations/pilani-tour.aspx"/>
...
<asp:TreeNode Text="Gangtok" NavigateUrl="Sikkim-Destinations/Gangtok.aspx"/>
</asp:TreeNode>
...
<asp:TreeNode Text="Kancheepuram" NavigateUrl="Tamil-Nadu-Destinations/Kancheepuram.aspx"/>
<asp:TreeNode Text="Madurai" NavigateUrl="Tamil-Nadu-Destinations/Madurai.aspx"/>
...
<asp:TreeNode Text="Thanjavur" NavigateUrl="Tamil-Nadu-Destinations/Thanjavur.aspx"/>
...
<asp:TreeNode Text="Agartala" NavigateUrl="Tripura-Destinations/Agartala.aspx"/>
</asp:TreeNode>
...
<asp:TreeNode Text="Agra" NavigateUrl="Uttar-Pradesh-Destinations/Agra.aspx"/>
<asp:TreeNode Text="Amethi" NavigateUrl="Uttar-Pradesh-Destinations/amethi-tour.aspx"/>
<asp:TreeNode Text="Allahabad" NavigateUrl="Uttar-Pradesh-Destinations/Allahabad.aspx"/>
<asp:TreeNode Text="Azamgarh" NavigateUrl="Uttar-Pradesh-Destinations/Azamgarh-tour.aspx"/>
<asp:TreeNode Text="Dadri" NavigateUrl="Uttar-Pradesh-Destinations/dadri-tour.aspx"/>

<asp:TreeNode Text="Faizabad" NavigateUrl="Uttar-Pradesh-Destinations/faizabad-tour.aspx"/>
<asp:TreeNode Text="Firozabad" NavigateUrl="Uttar-Pradesh-Destinations/firozabad-tour.aspx"/>
<asp:TreeNode Text="Fatehpur Sikri" NavigateUrl="Uttar-Pradesh-Destinations/fatehpur-sikri.aspx"/>
<asp:TreeNode Text="Ghaziabad" NavigateUrl="Uttar-Pradesh-Destinations/Ghaziabad.aspx"/>
<asp:TreeNode Text="Jhansi" NavigateUrl="Uttar-Pradesh-Destinations/jhansi.aspx"/>
<asp:TreeNode Text="Kanpur" NavigateUrl="Uttar-Pradesh-Destinations/Kanpur.aspx"/>
<asp:TreeNode Text="Lucknow" NavigateUrl="Uttar-Pradesh-Destinations/Lucknow.aspx"/>
<asp:TreeNode Text="Mathura" NavigateUrl="Uttar-Pradesh-Destinations/Mathura.aspx"/>
...
<asp:TreeNode Text="Mussoorie" NavigateUrl="Uttar-Pradesh-Destinations/Mussoorie.aspx"/>
...
<asp:TreeNode Text="Haldwani" NavigateUrl="Uttarakhand-Destinations/haldwani-tour.aspx"/>
...
<asp:TreeNode Text="Asansol" NavigateUrl="West-Bengal-Destinations/asansol.aspx"/>
<asp:TreeNode Text="Darjeeling" NavigateUrl="West-Bengal-Destinations/Darjeeling.aspx"/>
<asp:TreeNode Text="Darjeeling Hill Stations" NavigateUrl="West-Bengal-Destinations/Darjeeling-hillstations.aspx"/>
<asp:TreeNode Text="Durgapur" NavigateUrl="West-Bengal-Destinations/Durgapur.aspx"/>
