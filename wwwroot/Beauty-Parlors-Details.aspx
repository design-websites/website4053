<%@ Page Language="C#" MasterPageFile="Inner.Master" AutoEventWireup="true" CodeFile="Beauty-Parlors-Details.aspx.cs" Inherits="Parlors" 
  ...
  <div class="container">		
	<div id="main-content-wrap">
		<div id="main-content" class="clearfix">
			<div id="breadcrumbs">
					<a href="../Default.aspx" title="India City Trip">Home</a> &raquo; <% Response.Write(Request.QueryString["name"]); %> Beauty Parlors Details</div> <!-- end #breadcrumbs -->			<div id="top-shadow"></div>
			<div id="recent-posts" class="clearfix">
				<div class="entry post clearfix">
					<h1> <% Response.Write(Request.QueryString["name"]); %> Beauty Parlor contact </h1>
...
<asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" CellPadding="3"
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:desh %>"
                            SelectCommand="SELECT * FROM [Beautyparlors] WHERE ([Name] = @Name)">
                            <SelectParameters>
