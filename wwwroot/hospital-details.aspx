<%@ Page Language="C#" MasterPageFile="Inner.Master" AutoEventWireup="true" CodeFile="Hospital-Details.aspx.cs" Inherits="Hospitals" 
Title="Hospital Details" CodeFileBaseClass="BasePage"  Meta_Description="The contact details of hospitals in India ."
Meta_Keywords="hospitals contact details, addresses of hospitals in india, hospitals in india, hospitals, list of hospitals in india, hospitals in Bangalore, hospitals in hyderabad, hospitals in pune, hospitals in delhi, hospitals in ahmedabad, hospitals in calicut, hospitals in chennai, hospitals in mumbai" %>
  ...
  <div class="container">		
	<div id="main-content-wrap">
		<div id="main-content" class="clearfix">
			<div id="breadcrumbs">
					<a href="../Default.aspx" title="India City Trip">Home</a> &raquo; Hospital Details</div> <!-- end #breadcrumbs -->			<div id="top-shadow"></div>
			<div id="recent-posts" class="clearfix">
				<div class="entry post clearfix">
					<h1 class="title" title="Hospital Details">Hospital Details</h1>
...
<asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" CellPadding="3"
                            ...
                            <Fields>
                                 ...
                                 <asp:BoundField DataField="Name"  HeaderText="Hospital Name" SortExpression="Name" />
                       ...
                       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:desh %>"
                            SelectCommand="SELECT [Name], [Category], [Address1], [Address2], [Area], [City], [State], [Pincode], [STD], [Phone], [Fax] FROM [Hospitals] WHERE ([Name] = @Name)">
                            <SelectParameters>
