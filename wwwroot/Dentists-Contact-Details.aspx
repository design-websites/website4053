<%@ Page Language="C#" MasterPageFile="Inner.Master" AutoEventWireup="true" CodeFile="Dentists-Contact-Details.aspx.cs" Inherits="Dentists" 
Title="Dentists Contact Details" CodeFileBaseClass="BasePage"  Meta_Description="The contact details of dentists in India ."
Meta_Keywords="dentists contact details, addresses of dentists in india, dentists in india, dentists, list of dentists in india, dentists in Bangalore, dentists in hyderabad, dentists in pune, dentists in delhi, dentists in ahmedabad, dentists in calicut, dentists in chennai, dentists in mumbai" %>
  ...
  <div class="container">		
	<div id="main-content-wrap">
		<div id="main-content" class="clearfix">
			<div id="breadcrumbs">
					<a href="../Default.aspx" title="India City Trip">Home</a> &raquo; Dentists Contact Details</div> <!-- end #breadcrumbs -->			<div id="top-shadow"></div>
...
<br/>
    ...
    <br />
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:desh %>"
                            SelectCommand="SELECT * FROM [dentists] WHERE ([Name] = @Name)">
                            <SelectParameters>
