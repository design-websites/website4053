<%@ Page Language="C#" MasterPageFile="Inner.Master" AutoEventWireup="true" CodeFile="Astrologers-Contact-Details.aspx.cs" Inherits="Astrologers" 
  ...
  <div class="container">		
	<div id="main-content-wrap">
		<div id="main-content" class="clearfix">
			<div id="breadcrumbs">
					<a href="../Default.aspx" title="India City Trip">Home</a> &raquo; <% Response.Write(Request.QueryString["name"]); %> Astrologers </div> <!-- end #breadcrumbs -->			<div id="top-shadow"></div>
			<div id="recent-posts" class="clearfix">
				<div class="entry post clearfix">
					<h1> <% Response.Write(Request.QueryString["name"]); %> Contact Details </h1> <br/>
...
<asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" CellPadding="3"
                            ...
                            <Fields>
                                ...
                                <asp:BoundField DataField="Details" HeaderText="Business Details" SortExpression="Details" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:desh %>"
                            SelectCommand="SELECT * FROM [Astrologers] WHERE ([Name] = @Name)">
                            <SelectParameters>
...
<p> Get <a href="https://www.weekly-horoscope.info/" target="_blank" rel="nofollow">Free Weekly horoscope </a> </p>
<br/> Visit <a href="https://www.astrocenter.in/" target="_blank" rel="nofollow"> Astrocenter </a> for astrology advice.
</form>
