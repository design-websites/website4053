<%@ Page Title="India City Trip | Sitemap" Language="C#" MasterPageFile="Inner.Master" AutoEventWireup="true" CodeFile="pictures.aspx.cs" Inherits="Sitemap" %>
...
<asp:TreeNode Text="Hill Stations pictures" NavigateUrl="pictures/Hillstation/Hillstations.aspx">
<asp:TreeNode Text="Pilgrimage pictures" NavigateUrl="pictures/Pilgrimage/Pilgrimage.aspx"/>
...
<asp:TreeNode Text="Itanagar pictures" NavigateUrl="pictures/Itanagar/Itanagar.aspx"/>
...
<asp:TreeNode Text="Guwahati Tour" NavigateUrl="pictures/Guwahati/Guwahati.aspx"/>
...
<asp:TreeNode Text="Goa" NavigateUrl="pictures/Goa/Goa.aspx">
...
<asp:TreeNode Text="Ahmedabad Tour" NavigateUrl="pictures/Ahmedabad/Ahmedabad.aspx"/>
...
<asp:TreeNode Text="Faridabad Trip" NavigateUrl="pictures/Faridabad/Faridabad.aspx"/>
...
<asp:TreeNode Text="Gurgaon Slide show" NavigateUrl="pictures/Gurgaon/Gurgaon.aspx"/>
...
<asp:TreeNode Text="Himachal Pradesh pictures" NavigateUrl="pictures/Himachal/Himachal.aspx" ImageUrl="https://storage.googleapis.com/createweb/indiacitytrip.com/code/images/folder.gif" >
...
<asp:TreeNode Text="Karnataka pictures" NavigateUrl="pictures/Karnataka/Karnataka.aspx" ImageUrl="https://storage.googleapis.com/createweb/indiacitytrip.com/code/images/folder.gif" >
...
<asp:TreeNode Text="Kerala pictures" NavigateUrl="pictures/Kerala/Kerala.aspx" ImageUrl="https://storage.googleapis.com/createweb/indiacitytrip.com/code/images/folder.gif" >
...
<asp:TreeNode Text="Kottayam pictures" NavigateUrl="pictures/Kottayam/Kottayam.aspx"/>
...
<asp:TreeNode Text="Madhya Pradesh" NavigateUrl="pictures/Madhya-Pradesh/Madhya-Pradesh.aspx" ImageUrl="https://storage.googleapis.com/createweb/indiacitytrip.com/code/images/folder.gif" >
...
<asp:TreeNode Text="Jabalpur pictures" NavigateUrl="pictures/Jabalpur/Jabalpur.aspx"/>
...
<asp:TreeNode Text="Maharashtra pictures" NavigateUrl="pictures/Maharashtra/Maharashtra.aspx" ImageUrl="https://storage.googleapis.com/createweb/indiacitytrip.com/code/images/folder.gif" >
...
<asp:TreeNode Text="Mahabaleshwar pictures" NavigateUrl="pictures/Mahabaleshwar/Mahabaleshwar.aspx"/>
...
<asp:TreeNode Text="Manipur pictures" NavigateUrl="pictures/Manipur/Manipur.aspx" ImageUrl="https://storage.googleapis.com/createweb/indiacitytrip.com/code/images/folder.gif" >
<asp:TreeNode Text="Imphal pictures" NavigateUrl="pictures/Imphal/Imphal.aspx"/>
</asp:TreeNode>
<asp:TreeNode Text="Mizoram pictures" NavigateUrl="pictures/Mizoram/Mizoram.aspx" ImageUrl="https://storage.googleapis.com/createweb/indiacitytrip.com/code/images/folder.gif" >
<asp:TreeNode Text="Aizawl trip" NavigateUrl="Mizoram-Destinations/Aizawl.aspx"/>
</asp:TreeNode>
<asp:TreeNode Text="Orissa pictures" NavigateUrl="pictures/Orissa/Orissa.aspx" ImageUrl="https://storage.googleapis.com/createweb/indiacitytrip.com/code/images/folder.gif" >
...
<asp:TreeNode Text="Punjab pictures" NavigateUrl="pictures/Punjab/Punjab.aspx" ImageUrl="https://storage.googleapis.com/createweb/indiacitytrip.com/code/images/folder.gif" >
<asp:TreeNode Text="Amritsar Tour" NavigateUrl="Punjab-Destinations/Amritsar.aspx"/>
<asp:TreeNode Text="Hoshiarpur pictures" NavigateUrl="pictures/Hoshiarpur/Hoshiarpur.aspx"/>
...
<asp:TreeNode Text="Rajasthan pictures" NavigateUrl="pictures/Rajasthan/Rajasthan.aspx" ImageUrl="https://storage.googleapis.com/createweb/indiacitytrip.com/code/images/folder.gif" >
<asp:TreeNode Text="Ajmer" NavigateUrl="pictures/Ajmer/Ajmer.aspx"/>
...
<asp:TreeNode Text="Jaipur pictures" NavigateUrl="pictures/Jaipur/Jaipur.aspx"/>
...
<asp:TreeNode Text="Sikkim pictures" NavigateUrl="pictures/Sikkim/Sikkim.aspx" ImageUrl="https://storage.googleapis.com/createweb/indiacitytrip.com/code/images/folder.gif" >
...
<asp:TreeNode Text="Agra Slide Show" NavigateUrl="pictures/Agra/Agra.aspx"/>
...
<asp:TreeNode Text="Lucknow pictures" NavigateUrl="pictures/Lucknow/Lucknow.aspx"/>
...
<asp:TreeNode Text="Kolkata pictures" NavigateUrl="pictures/Kolkata/Kolkata.aspx"/>
